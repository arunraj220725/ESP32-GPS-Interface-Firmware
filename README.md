...
The firmware reads and processes NMEA sentences in a FreeRTOS task, validated on physical hardware.
...
UART driver initialization via ESP-IDF
...
Tested with ESP32 + NEO-6M in real hardware conditions.
